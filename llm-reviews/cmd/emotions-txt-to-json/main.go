...
var synonyms = map[string][]string{
	...
	"трагизм":   {"смерт", "судьба", "безнадежн", "трагед", "безнадёжн", "безысходн", "горе", "потеря надежды", "судьба", "рок"},
	"грусть":    {"печал", "груст", "скорб", "пессим", "расстройство", "потеря надежды", "унын", "тоска", "потеря", "огорчен", "слёз", "меланхол"},
	...
	"надежда":       {"вера"},
	"уют":           {"беззабот", "лёгкость", "расслабление", "утешение", "тёплота", "душевность"},

	"интрига": {"интриг", "интерес", "непредсказуем", "запутанн", "удивлен", "сюрприз", "обман", "тайна", "раздум", "напряжен"},
}
